...
var app = (function () {
    ...
    */  
    ...
    /* src/Social.svelte generated by Svelte v3.15.0 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img8 = element("img");
    			t18 = text("\n    Whatsapp");
    			attr_dev(button, "class", "btn btn-lite dropdown-toggle");
    			attr_dev(button, "type", "button");
    			attr_dev(button, "id", "dropdownMenuButton");
    			attr_dev(button, "data-toggle", "dropdown");
    			attr_dev(button, "aria-haspopup", "true");
    			attr_dev(button, "aria-expanded", "false");
    			add_location(button, file, 1, 2, 50);
    			set_style(img0, "height", "2rem");
    			if (img0.src !== (img0_src_value = "social-share-urls/images/logo-icons-opaque-background/twitter.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "Twitter");
    			add_location(img0, file, 9, 4, 430);
    			attr_dev(a0, "class", "dropdown-item");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "href", a0_href_value = "https://twitter.com/intent/tweet?url=" + ctx.url + "&text=" + ctx.title);
    			add_location(a0, file, 7, 4, 316);
    			set_style(img1, "height", "2rem");
    			if (img1.src !== (img1_src_value = "social-share-urls/images/logo-icons-opaque-background/add.this.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "AddThis");
    			add_location(img1, file, 15, 4, 675);
    			attr_dev(a1, "class", "dropdown-item");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", a1_href_value = "http://www.addthis.com/bookmark.php?url=" + ctx.url);
    			add_location(a1, file, 13, 4, 571);
    			set_style(img2, "height", "2rem");
    			if (img2.src !== (img2_src_value = "social-share-urls/images/logo-icons-opaque-background/sms.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "SMS");
    			add_location(img2, file, 21, 4, 902);
    			attr_dev(a2, "class", "dropdown-item");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "href", a2_href_value = "sms:?&body=" + ctx.title + ": " + ctx.url + " ");
    			add_location(a2, file, 19, 4, 817);
    			set_style(img3, "height", "2rem");
    			if (img3.src !== (img3_src_value = "social-share-urls/images/logo-icons-opaque-background/skype.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Skype");
    			add_location(img3, file, 27, 4, 1140);
    			attr_dev(a3, "class", "dropdown-item");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "href", a3_href_value = "https://web.skype.com/share?url=" + ctx.url + "&text=" + ctx.title);
    			add_location(a3, file, 25, 4, 1031);
    			set_style(img4, "height", "2rem");
    			if (img4.src !== (img4_src_value = "social-share-urls/images/logo-icons-opaque-background/telegram.me.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Telegram");
    			add_location(img4, file, 33, 4, 1386);
    			attr_dev(a4, "class", "dropdown-item");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "href", a4_href_value = "https://telegram.me/share/url?url=" + ctx.url + "&text=" + ctx.title);
    			add_location(a4, file, 31, 4, 1275);
    			set_style(img5, "height", "2rem");
    			if (img5.src !== (img5_src_value = "social-share-urls/images/logo-icons-opaque-background/viber.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "Viber");
    			add_location(img5, file, 39, 4, 1627);
    			attr_dev(a5, "class", "dropdown-item");
    			attr_dev(a5, "target", "_blank");
    			attr_dev(a5, "href", a5_href_value = "viber://forward?text=" + ctx.title + ": " + ctx.url);
    			add_location(a5, file, 37, 4, 1533);
    			set_style(img6, "height", "2rem");
    			if (img6.src !== (img6_src_value = "social-share-urls/images/logo-icons-opaque-background/email.png")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "Email");
    			add_location(img6, file, 46, 4, 1859);
    			attr_dev(a6, "class", "dropdown-item");
    			attr_dev(a6, "target", "_blank");
    			attr_dev(a6, "href", a6_href_value = "mailto:?subject=" + ctx.title + "&body=" + ctx.url);
    			add_location(a6, file, 44, 4, 1766);
    			set_style(img7, "height", "2rem");
    			if (img7.src !== (img7_src_value = "social-share-urls/images/logo-icons-opaque-background/gmail.png")) attr_dev(img7, "src", img7_src_value);
    			attr_dev(img7, "alt", "Gmail");
    			add_location(img7, file, 52, 4, 2112);
    			attr_dev(a7, "class", "dropdown-item");
    			attr_dev(a7, "target", "_blank");
    			attr_dev(a7, "href", a7_href_value = "https://mail.google.com/mail/?view=cm&su=" + ctx.title + "&body=" + ctx.url);
    			add_location(a7, file, 50, 4, 1994);
    			set_style(img8, "height", "2rem");
    			if (img8.src !== (img8_src_value = "social-share-urls/images/logo-icons-opaque-background/whatsapp.png")) attr_dev(img8, "src", img8_src_value);
    			attr_dev(img8, "alt", "Whatsapp");
    			add_location(img8, file, 58, 4, 2341);
    			attr_dev(a8, "class", "dropdown-item");
    			attr_dev(a8, "target", "_blank");
    			attr_dev(a8, "href", a8_href_value = "whatsapp://send?text=" + ctx.title + ": " + ctx.url);
    			add_location(a8, file, 56, 4, 2247);
    			attr_dev(div0, "class", "dropdown-menu");
    			attr_dev(div0, "aria-labelledby", "dropdownMenuButton");
    			add_location(div0, file, 6, 2, 247);
    		...
    		p: function update(changed, ctx) {
    			...
    			if (!current || (changed.url || changed.title) && a0_href_value !== (a0_href_value = "https://twitter.com/intent/tweet?url=" + ctx.url + "&text=" + ctx.title)) {
    				attr_dev(a0, "href", a0_href_value);
    			}

    			if (!current || changed.url && a1_href_value !== (a1_href_value = "http://www.addthis.com/bookmark.php?url=" + ctx.url)) {
    				attr_dev(a1, "href", a1_href_value);
    			}

    			if (!current || (changed.title || changed.url) && a2_href_value !== (a2_href_value = "sms:?&body=" + ctx.title + ": " + ctx.url + " ")) {
    				attr_dev(a2, "href", a2_href_value);
    			}

    			if (!current || (changed.url || changed.title) && a3_href_value !== (a3_href_value = "https://web.skype.com/share?url=" + ctx.url + "&text=" + ctx.title)) {
    				attr_dev(a3, "href", a3_href_value);
    			}

    			if (!current || (changed.url || changed.title) && a4_href_value !== (a4_href_value = "https://telegram.me/share/url?url=" + ctx.url + "&text=" + ctx.title)) {
    				attr_dev(a4, "href", a4_href_value);
    			}

    			if (!current || (changed.title || changed.url) && a5_href_value !== (a5_href_value = "viber://forward?text=" + ctx.title + ": " + ctx.url)) {
    				attr_dev(a5, "href", a5_href_value);
    			}

    			if (!current || (changed.title || changed.url) && a6_href_value !== (a6_href_value = "mailto:?subject=" + ctx.title + "&body=" + ctx.url)) {
    				attr_dev(a6, "href", a6_href_value);
    			}

    			if (!current || (changed.title || changed.url) && a7_href_value !== (a7_href_value = "https://mail.google.com/mail/?view=cm&su=" + ctx.title + "&body=" + ctx.url)) {
    				attr_dev(a7, "href", a7_href_value);
    			}

    			if (!current || (changed.title || changed.url) && a8_href_value !== (a8_href_value = "whatsapp://send?text=" + ctx.title + ": " + ctx.url)) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { loc } = $$props;
    	let { mysockid } = $$props;
    	let { title = "My screen share url" } = $$props;
    	let { user_id } = $$props;
    	let { hash_tags } = $$props;
    	const writable_props = ["loc", "mysockid", "title", "user_id", "hash_tags"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("user_id" in $$props) $$invalidate("user_id", user_id = $$props.user_id);
    		if ("hash_tags" in $$props) $$invalidate("hash_tags", hash_tags = $$props.hash_tags);
    	...
    	$$self.$$.update = (changed = { loc: 1, mysockid: 1 }) => {
    		if (changed.loc || changed.mysockid) {
    			 $$invalidate("url", url = encodeURIComponent(`${loc}?room=${mysockid}`));
    		}
    	};
    ...
    class Social extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (ctx.loc === undefined && !("loc" in props)) {
    			console.warn("<Social> was created without expected prop 'loc'");
    		}

    		if (ctx.mysockid === undefined && !("mysockid" in props)) {
    			console.warn("<Social> was created without expected prop 'mysockid'");
    		}

    		if (ctx.user_id === undefined && !("user_id" in props)) {
    			console.warn("<Social> was created without expected prop 'user_id'");
    		}

    		if (ctx.hash_tags === undefined && !("hash_tags" in props)) {
    			console.warn("<Social> was created without expected prop 'hash_tags'");
    		}
    	}
    ...
    const file$1 = "src/ScreenPublish.svelte";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 17, 12, 625);
    			add_location(center, file$1, 17, 4, 617);
    			add_location(br0, file$1, 19, 9, 725);
    			add_location(br1, file$1, 20, 15, 745);
    			attr_dev(button, "class", "btn btn-dark centered-element svelte-1qeebiq");
    			set_style(button, "color", "lawngreen");
    			add_location(button, file$1, 11, 2, 491);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 57, 2, 1639);
    ...
    // (76:2) <Social mysockid={mysockid} loc={loc} >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(76:2) <Social mysockid={mysockid} loc={loc} >",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(social, label, null);
    			...
    			puf_action = puf.call(null, button, { text: "Copied to clipboard" }) || ({});
    			current = true;
    		},
    		p: function update(changed, ctx) {
    			...
    			if (changed.mysockid) social_changes.mysockid = ctx.mysockid;

    			if (changed.$$scope) {
    				social_changes.$$scope = { changed, ctx };
    			}

    			social.$set(social_changes);
    			if (!current || changed.mysockid) set_data_dev(t18, ctx.mysockid);

    			if (!current || changed.mysockid && a_href_value !== (a_href_value = "" + (ctx.loc + "?room=" + ctx.mysockid))) {
    ...
    class ScreenPublish extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { mysockid: 0, stream: 0 });
    ...
    const file$2 = "src/ScreenSubscribe.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$2, 4, 0, 69);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ScreenSubscribe extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { broadcasterSockId: 0, mysockid: 0 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 38, 0, 1063);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { mysockid: 0 });
    ...
    */
    ...
    var socket$3 = window.socket = lib$1.connect();
    var NAME;
    ...
    socket$3.on('connect', function (data) {
      socket$3.emit('auth', NAME, function(name){
        NAME = name;
